...
describe('SimulationObject', () => {
  ...
  beforeEach(() => {
    busSimObj = new SimulationObject(SimulationObject.Type.SIGNAL, ['top', 'databus'], busSignal, null);
  });
  ...
  test('cloneRange creates a new SimulationObject with correct hierarchy and signal', () => {
    ...
    // invalid inputs 
    expect(() => bitSimObj.cloneRange(1, 3))
      .toThrow('Cannot clone range [1:3] of signal top.sig with width 1');
